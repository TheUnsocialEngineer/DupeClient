...
public final class P2wAlertScreen extends Screen {
    ...
    private void drawPanel(GuiGraphics context) {
        ...
        context.drawCenteredString(this.font, Component.literal("Community P2W Server"), cx, py + 14, 0xFFFBBF24);
        context.drawCenteredString(this.font, Component.literal(this.server), cx, py + 34, 0xFFE5E7EB);
        String scoreLine = scorePercent >= 0
                ? "Community P2W score: " + scorePercent + "%"
                : "This server is marked pay-to-win by the community.";
        context.drawCenteredString(this.font, Component.literal(scoreLine), cx, py + 50, 0xFF93C5FD);
