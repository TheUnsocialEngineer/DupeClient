 ...
 */
public class ScannerActionButton extends ClickableWidget {
    private final Runnable onPress;

    public ScannerActionButton(int x, int y, int width, int height, Text message, Runnable onPress) {
    ...
    protected void renderWidget(DrawContext context, int mouseX, int mouseY, float deltaTicks) {
        ...
        context.drawCenteredTextWithShadow(tr, getMessage(), x1 + getWidth() / 2, ty, color);
    }
