...
public final class MidnightShapes {
    ...
    public static void fillDisk(DrawContext c, int cx, int cy, int r, int argb) {
        UiNativeRenderer.fillDisk(c, cx, cy, r, argb);
    }

    public static void fillRoundedRect(DrawContext c, int x, int y, int w, int h, int rad, int argb) {
        UiNativeRenderer.fillRoundedRect(c, x, y, w, h, rad, argb);
    }

    public static void fillRoundedFrame(DrawContext c, int x, int y, int w, int h, int r, int innerArgb, int borderArgb) {
