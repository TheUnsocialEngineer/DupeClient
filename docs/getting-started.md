...
This URL is baked into the mod jar at build time. Override per-client in `.minecraft/config/dupeclient/presence.json` (`apiBase` field), or at build time with `-PpresenceApiBase=...`.
